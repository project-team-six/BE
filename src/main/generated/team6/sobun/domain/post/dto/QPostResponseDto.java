...
public class QPostResponseDto extends ConstructorExpression<PostResponseDto> {
    ...
    public QPostResponseDto(com.querydsl.core.types.Expression<Long> id, com.querydsl.core.types.Expression<Long> userId, com.querydsl.core.types.Expression<team6.sobun.domain.post.entity.Category> category, com.querydsl.core.types.Expression<String> title, com.querydsl.core.types.Expression<String> nickname, com.querydsl.core.types.Expression<String> content, com.querydsl.core.types.Expression<java.time.LocalDateTime> createdAt, com.querydsl.core.types.Expression<Long> pined, com.querydsl.core.types.Expression<Integer> views, com.querydsl.core.types.Expression<Integer> commentCount) {
        super(PostResponseDto.class, new Class<?>[]{long.class, long.class, team6.sobun.domain.post.entity.Category.class, String.class, String.class, String.class, java.time.LocalDateTime.class, long.class, int.class, int.class}, id, userId, category, title, nickname, content, createdAt, pined, views, commentCount);
